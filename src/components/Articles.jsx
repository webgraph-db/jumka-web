...
const articles = [
  {
    id: 1,
    title: 'जुम्का समुदायको सांस्कृतिक उत्सव',
    excerpt: 'वर्षमा एक पटक आयोजना हुने हाम्रो प्रमुख सांस्कृतिक उत्सवको विस्तृत विवरण र महत्व।',
    image: 'https://images.unsplash.com/photo-1609137144816-7d8b7a996252?w=600&q=80',
    date: '१५ असार, २०८१',
    category: 'संस्कृति',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1456513087680-66ae7f7b2a2?w=600&q=80',
    date: '२८ जेठ, २०८१',
    category: 'वंशावली',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1529156069898-b499f0a58a2?w=600&q=80',
    date: '१० जेष्ठ, २०८१',
    category: 'समुदाय',
  },
  {
